...
//                deletableView.setText(tag.deleteIcon);
                deletableView.setImageDrawable(getResources().getDrawable(R.drawable.ic_delete_tags));
...
//                deletableView.setTextSize(TypedValue.COMPLEX_UNIT_SP, tag.deleteIndicatorSize);
                ...
                tagWidth += deletableView.getWidth() + deletableView.getPaddingLeft() + deletableView.getPaddingRight();
